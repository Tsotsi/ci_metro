...
class Welcome extends TT_Controller {
	...
	{
            echo $this->router->directory,'<hr>';
            echo $this->router->class,'<hr>';
...
//$this->load->library('rbac/reflectItem');
//var_dump($this);
//echo '<pre>';
//var_dump($this->reflectitem->getClass());
...
return $this->captcha->getCode();
        ...
        public function init()
        {
            $this->load->model('test_model');
             $this->load->dbforge();
            $this->load->dbutil($this->load->database('default',TRUE));
            if(!$this->dbutil->database_exists('photo')){
                echo 'no';
            }else{
                echo 'yes';
            }
